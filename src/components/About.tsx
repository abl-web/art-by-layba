...
import artistStudio from "../../public/images/artist-studio.jpg";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-14 md:gap-20 items-center relative">
        ...
        <div>
          ...
          <p className="mt-2 font-serif italic text-xl text-wine">
            Fine Artist · Lahore, Pakistan
          </p>

          <div className="mt-8 space-y-5 text-charcoal/80 leading-relaxed font-light">
            <p>
              Layba is a Lahore-based fine artist whose practice moves between classical
              portraiture, atmospheric landscapes and meditative abstraction. Her work
              investigates the quiet tension between presence and memory — how a feeling,
              a place, or a face lingers long after the moment has passed.
            </p>
            <p>
              Trained in the fundamentals of colour, form and composition, she works
              primarily in oils and acrylics on canvas, layering each piece by hand to
              create depth, texture and a sense of stillness. Her palette is rooted in
              the warm earth tones of Punjab — terracotta, ochre, indigo — punctuated by
              the occasional flash of gold leaf.
            </p>
            <p>
              Every painting begins as a conversation — with a client, with a memory, or
              with the blank canvas itself — and ends as something entirely its own.
            </p>
          </div>
